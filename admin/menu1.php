<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">SOLARCELL</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed1" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                ข้อมูลพื้นฐาน(พนักงาน)
                                
                            </a>
                            
                                <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="show_employee.php">รายชื่อพนักงาน</a>
                                <a class="nav-link" href="fr_employee.php">เพิ่มข้อมูลพนักงาน</a>
                                </nav>
